const clickLikeButton = async (likedButton, movie, container) => {
    ...
    if (IS_CLICK_ON_FAVORITE_SECTION && AMOUNT_MOVIES_NOT_ZERO) {
        ...
        const NODES_LIKED_BUTTON_TRENDS = $$('#main__carousel-container-id .liked-movie__button--liked');
        const LIKED_BUTTON_TRENDS = Array.from(NODES_LIKED_BUTTON_TRENDS);
        const BUTTON_SIMILAR = LIKED_BUTTON_TRENDS.find((btn) => btn.getAttribute('data-id') === LIKED_BUTTON_ID);
